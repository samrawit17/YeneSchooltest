...
export const FEATURE_LIST = [
  ...
  { key: 'ATTENDANCE_TRACKING', name: 'Attendance Tracking', description: 'Student and employee attendance tracking', tier: 'STANDARD' },
  ...
  { key: 'HR_MANAGEMENT', name: 'HR Management', description: 'Human resources and payroll management', tier: 'STANDARD' },

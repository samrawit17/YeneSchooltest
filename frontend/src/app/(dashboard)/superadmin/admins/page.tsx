      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" className="gap-2 dark:bg-[#2A2A2A] dark:border-[#2A2A2A] dark:text-gray-200" onClick={fetchAdmins}>
        ...
        <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
          <DialogContent className="max-w-md dark:bg-[#2A2A2A] dark:border-[#2A2A2A]">
            <SchoolAdminForm

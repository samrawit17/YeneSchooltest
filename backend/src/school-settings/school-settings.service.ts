...
export const SCHOOL_SETTING_KEYS = {
  ...
  DATA_QUALITY_REQUIRE_STUDENT_CODE: 'DATA_QUALITY_REQUIRE_STUDENT_CODE',
  DATA_QUALITY_REQUIRE_FAYDA: 'DATA_QUALITY_REQUIRE_FAYDA',
  DATA_QUALITY_REQUIRE_MOTHER_NAME: 'DATA_QUALITY_REQUIRE_MOTHER_NAME',
  DATA_QUALITY_REQUIRE_PARENT: 'DATA_QUALITY_REQUIRE_PARENT',
  DATA_QUALITY_REQUIRE_STUDENT_PHONE: 'DATA_QUALITY_REQUIRE_STUDENT_PHONE',
  DATA_QUALITY_REQUIRE_STAFF_EMAIL: 'DATA_QUALITY_REQUIRE_STAFF_EMAIL',
  DATA_QUALITY_REQUIRE_STAFF_PHONE: 'DATA_QUALITY_REQUIRE_STAFF_PHONE',
  DATA_QUALITY_CHECK_DUPLICATE_CODE: 'DATA_QUALITY_CHECK_DUPLICATE_CODE',
  DATA_QUALITY_CHECK_CLASS_MISMATCH: 'DATA_QUALITY_CHECK_CLASS_MISMATCH',
  DATA_QUALITY_CHECK_SECTION_MISMATCH: 'DATA_QUALITY_CHECK_SECTION_MISMATCH',
  DATA_QUALITY_CHECK_CLASS_HOMEROOM: 'DATA_QUALITY_CHECK_CLASS_HOMEROOM',
  DATA_QUALITY_CHECK_TIMETABLE_CONFLICT: 'DATA_QUALITY_CHECK_TIMETABLE_CONFLICT',
  DATA_QUALITY_CHECK_ENROLLMENT: 'DATA_QUALITY_CHECK_ENROLLMENT',
  DATA_QUALITY_CHECK_PARENT_MISMATCH: 'DATA_QUALITY_CHECK_PARENT_MISMATCH',
  DATA_QUALITY_CHECK_PROFILE_CLASS: 'DATA_QUALITY_CHECK_PROFILE_CLASS',
} as const;
...
export class SchoolSettingsService {
  ...
  private readonly booleanKeys = new Set([
    ...
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_STUDENT_CODE,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_FAYDA,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_MOTHER_NAME,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_PARENT,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_STUDENT_PHONE,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_STAFF_EMAIL,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_REQUIRE_STAFF_PHONE,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_DUPLICATE_CODE,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_CLASS_MISMATCH,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_SECTION_MISMATCH,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_CLASS_HOMEROOM,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_TIMETABLE_CONFLICT,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_ENROLLMENT,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_PARENT_MISMATCH,
    SCHOOL_SETTING_KEYS.DATA_QUALITY_CHECK_PROFILE_CLASS,
  ]);

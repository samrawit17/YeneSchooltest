...
describe('ReportCardService parent fee gate', () => {
    const createService = (overrides = {}) => {
                ...
                findMany: jest.fn().mockResolvedValue([
                    {
                        ...
                        academicYear: '2018',
                        term: 'Term 3',
                        status: report_card_service_1.ReportCardStatus.PUBLISHED,
        ...
        return {
            prisma,
            service: new report_card_service_1.ReportCardService(prisma, {}),
        };
    };
    it('blocks parent report cards when the selected term fee is unpaid', async () => {
        ...
        await expect(service.getPublishedReportCardsForParent('parent-user-1', 'student-user-1', 'school-1', {
            academicYear: '2018',
            term: 'Term 3',
    ...
    it('returns published report cards after the selected annual fee period is paid', async () => {
        ...
        const cards = await service.getPublishedReportCardsForParent('parent-user-1', 'student-user-1', 'school-1', {
            academicYear: '2018',
            term: 'Term 3',
        });
        expect(cards).toHaveLength(1);
        expect(cards[0].gradeDetails).toEqual([{ subject: 'Math', score: 91 }]);
        expect(prisma.reportCard.findMany).toHaveBeenCalledWith(expect.objectContaining({
            where: {
                studentId: 'student-user-1',
                schoolId: 'school-1',
                status: report_card_service_1.ReportCardStatus.PUBLISHED,
...
//# sourceMappingURL=report-card-fee-gate.spec.js.map
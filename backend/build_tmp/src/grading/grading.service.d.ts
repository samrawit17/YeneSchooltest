...
export declare class GradingService {
    ...
    private upsertGradeScores;
    private buildMergedLegacyScores;
    private calculateTotalFromLegacyScores;
    ...
    private getProfileRosterWhere;
    private assertStudentInGradeEntryRoster;
    ...
    submitAllToRegistrar(teacherId: string, schoolId: string, academicYear: string, termId: string, classId: string, sectionId: string, subjectId: string): Promise<Prisma.BatchPayload>;
    ...
    bulkApproveGrades(registrarId: string, schoolId: string, gradeIds: string[]): Promise<Prisma.BatchPayload>;
    bulkRejectGrades(registrarId: string, schoolId: string, gradeIds: string[], comment: string): Promise<Prisma.BatchPayload>;
    ...
    getAssessmentTypes(schoolId: string): Promise<string | number | true | Prisma.JsonObject | Prisma.JsonArray | {
        code: string;
        name: string;
        percentage: number;
    }[]>;
    ...
    bulkPublish(schoolId: string, assessmentIds: string[], notifyParents: boolean): Promise<Prisma.BatchPayload>;

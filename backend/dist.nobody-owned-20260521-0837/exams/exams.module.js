...
exports.ExamsModule = ExamsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [exams_controller_1.ExamsController, seating_controller_1.SeatingController],
        providers: [exams_service_1.ExamsService, seating_service_1.SeatingService],
        exports: [exams_service_1.ExamsService, seating_service_1.SeatingService],
    })
], ExamsModule);

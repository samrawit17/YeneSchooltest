...
export declare class StudentController {
    ...
    getStudents(req: any, classId?: string, sectionId?: string, section?: string, status?: string, grade?: string, page?: string, limit?: string, search?: string, rollNumber?: string): Promise<{
        class: {
            id: string;
            name: string;
            grade: number | null;
    ...
    getMyHomeroomStudents(req: any): Promise<{
        data: {
            id: string;
            name: string;
            avatarUrl: string | null;

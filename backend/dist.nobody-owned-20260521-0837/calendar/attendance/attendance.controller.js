...
let AttendanceController = class AttendanceController {
    ...
    getTodayTimetable(req, query) {
        return this.attendanceService.getTodayTimetable(req.user, query.date);
    }
    createSession(req, slotId, dto) {
        return this.attendanceService.openAttendanceSession(req.user, slotId, dto.date);
    }
    getStudentsForAttendance(req, classId, sectionId, className, section, date) {
        return this.attendanceService.getStudentsForAttendance(req.user, className, section, date, classId, sectionId);
    }
    ...
    notifyMissing(req, date, grade, section) {
        const targetDate = date || new Date().toISOString().split('T')[0];
        return this.attendanceService.notifyMissingAttendance(req.user, targetDate, grade, section);
    }
    ...
    getAdminDashboard(req, date, startDate, endDate, grade, section, range) {
        return this.attendanceService.getAdminDashboard(req.user, date, startDate, endDate, grade, section, range);
    }
};
...
__decorate([
    (0, common_1.Post)('check-reminders'),
    (0, permissions_decorator_1.Permissions)('attendance:update'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AttendanceController.prototype, "triggerReminderCheck", null);
__decorate([
